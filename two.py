        ...
        f"""
            <style>
                [data-testid="stSidebar"] {{
                    background-image: url("https://www.engr.washington.edu/sites/engr/files/mycoe/marcom/ece/imgs/ECE_UW_stack_purp.jpg");
...
#collector = FeedbackCollector(project: str | None, email: str | None, password: str | None)
#collector.st_feedback(feedback_type="thumbs", path="engine_feedback.json")
#feedback
